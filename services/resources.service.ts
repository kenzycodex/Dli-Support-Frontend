// services/resources.service.ts (ENHANCED - With smart caching and role support)
...
class ResourcesService {
  ...
  // Enhanced API methods with caching and role support
  async getCategories(options: {
    ...
    try {
      const response = await apiClient.get<{ categories: ResourceCategory[] }>('/resources/categories', {
